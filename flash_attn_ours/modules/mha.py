...
from flash_attn_ours.utils.distributed import get_dim_for_local_rank
...
try:
    from flash_attn_ours.ops.fused_dense import ColumnParallelLinear, FusedDense, RowParallelLinear
except ImportError:
    FusedDense, ColumnParallelLinear, RowParallelLinear = None, None, None

try:
    from flash_attn_ours.layers.rotary import RotaryEmbedding
except ImportError:
