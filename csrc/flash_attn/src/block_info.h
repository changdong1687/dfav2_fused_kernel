...
struct BlockInfo {
    ...
    __device__ BlockInfo(const Params &params, const int bidb)
        ...
        , seqlen_q_vision(params.seqlen_q_vision)
        , seqlen_k_vision(params.seqlen_k_vision)
        , seqlen_q_text(params.seqlen_q_text)
        , seqlen_k_text(params.seqlen_k_text)
        {
        }
    ...
    const int seqlen_q_text;
    const int seqlen_k_text;
};
