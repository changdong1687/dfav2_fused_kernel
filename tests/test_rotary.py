...
from flash_attn_ours.layers.rotary import apply_rotary_emb, apply_rotary_emb_torch
from flash_attn_ours.layers.rotary import apply_rotary_emb_qkv_, apply_rotary_emb_kv_
from flash_attn_ours.bert_padding import pad_input, unpad_input
...
def test_compilation_count():
    ...
    from flash_attn_ours.ops.triton.rotary import rotary_kernel
    compilation_count = 0
